...
\par\includegraphics[max width=\linewidth]{C:/OpenSourceGit/AudacityTeamTools/test/m/images/8/88/audacity_logo_signika_512_transparent.png}\par
...
\end{itemize}
\par 
\par\includegraphics[max width=\linewidth]{C:/OpenSourceGit/AudacityTeamTools/test/m/images/5/51/theme_light.png}\par

\par\includegraphics[max width=\linewidth]{C:/OpenSourceGit/AudacityTeamTools/test/m/images/e/e3/theme_dark.png}\par
\par \textbf{Light} theme
\textbf{Dark} theme
\par 
\par\includegraphics[max width=\linewidth]{C:/OpenSourceGit/AudacityTeamTools/test/m/images/b/bc/theme_classic.png}\par

\par\includegraphics[max width=\linewidth]{C:/OpenSourceGit/AudacityTeamTools/test/m/images/c/c3/theme_hi_contrast.png}\par
...
\par\includegraphics[max width=\linewidth]{C:/OpenSourceGit/AudacityTeamTools/test/m/images/e/ef/connect_dots_stem_plot_examples.png}\par
...
\par\Needspace{122.0pt}\begin{picture}(242.0,22.0)
   \put(0,0){\includegraphics[scale=0.4]{C:/OpenSourceGit/AudacityTeamTools/test/m/images/0/0d/menu_toolbar_extra.png}}
...
\par\Needspace{208.5pt}\begin{picture}(237.0,108.5)
   \put(0,0){\includegraphics[scale=0.5]{C:/OpenSourceGit/AudacityTeamTools/test/m/images/6/6d/amplify.png}}
...
\par\Needspace{178.4pt}\begin{picture}(247.60000000000002,78.4)
   \put(0,0){\includegraphics[scale=0.4]{C:/OpenSourceGit/AudacityTeamTools/test/m/images/f/f8/preferences_keyboard_with_default_dropdown_menu_trimmed.png}}
