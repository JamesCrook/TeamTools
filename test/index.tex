...
}\includegraphics[max width=\linewidth]{C:/OpenSourceGit/AudacityTeamTools/test/m/images/b/b5/icon_faq.gif}  -  \textit{most common questions are answered in the FAQ}
\begin{itemize}
...
\par \includegraphics[max width=\linewidth]{C:/OpenSourceGit/AudacityTeamTools/test/m/images/7/7a/projectwindowimagemap_220.png}\par 
\subsubsection{Help buttons}
\begin{itemize}
\item \includegraphics[max width=\linewidth]{C:/OpenSourceGit/AudacityTeamTools/test/m/images/d/d6/help_button.png} Some places in Audacity have a help button, click for the relevant Manual page.
\end{itemize}
