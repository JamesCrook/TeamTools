...
// Extra
  ...
  { key:   "Screenshot (short format)...",
    id: "Screenshot",
    short: "A version of Help -> Screenshot with a more minimal GUI.  One of the most useful options is All_Tracks.  The _Plus suffix includes the timeline.",
    long:  "+"},
  ...
  { key:   "Apply Macro",
    id:    "Apply Macro",
    short: "Displays a menu with list of all your Macros. Selecting any of these Macros by clicking on it will cause that Macro to be applied to the current project. ",
    long:  "+."},
  { key:   "Palette...",
    id:    "Palette...",
