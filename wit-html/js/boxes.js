...
//  [ "Tracks_Menu:_Add_New#mono_track",""  ],
  ...
  [ "Effect_Menu#auto_duck", "Auto Duck"  ],
  [ "Effect_Menu#bass_and_treble", "Bass and Treble"  ],
  [ "Effect_Menu#change_pitch", "Change Pitch"  ],
  [ "Effect_Menu#change_speed", "Change Speed"  ],
  [ "Effect_Menu#change_tempo", "Change Tempo"  ],
  [ "Effect_Menu#classic_filters", "Classic Filters"  ],
  [ "Effect_Menu#click_removal", "Click Removal"  ],
  ...
  [ "Effect_Menu#noise_reduction", "Noise Reduction"  ],
  ...
  [ "Effect_Menu#sliding_time_scalepitch_shift", "Sliding Time Scale - Pitch" +
  "Shift"  ],
  [ "Effect_Menu#truncate_silence", "Truncate Silence"  ],
  [ "Effect_Menu#wahwah", "Wahwah"  ],
  [ "Effect_Menu#sc4", "SC4"  ],
  [ "Effect_Menu#adjustable_fade","Adjustable Fade"  ],
  [ "Effect_Menu#clip_fix","Clip Fix"   ],
  [ "Effect_Menu#crossfade_clips","Crossfade Clips"   ],
  [ "Effect_Menu#crossfade_tracks","Crossfade Tracks"   ],
  [ "Effect_Menu#delay","Delay"   ],
  [ "Effect_Menu#high_pass_filter","High Pass Filter"   ],
  [ "Effect_Menu#limiter","Limiter"   ],
  [ "Effect_Menu#low_pass_filter","Low Pass Filter"   ],
  [ "Effect_Menu#notch_filter","Notch Filter"   ],
  [ "Effect_Menu#nyquist_prompt","Nyquist Prompt"   ],
  [ "Effect_Menu#spectral_edit_multi_tool","Spectral edit multi tool"   ],
  [ "Effect_Menu#spectral_edit_parametric_eq","Spectral edit parametric EQ"   ],
  [ "Effect_Menu#spectral_edit_shelves","Spectral edit shelves"   ],
  [ "Effect_Menu#studio_fade_out","Fades#studio_fadeout"   ],
  [ "Effect_Menu#tremolo","Tremolo"   ],
  [ "Effect_Menu#vocal_reduction_and_isolation","Vocal Reduction and Isolation"   ],
  [ "Effect_Menu#vocal_remover","Vocal Remover"   ],
