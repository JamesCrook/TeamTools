...
Redirects =
  [
  [ "File_Menu:Export#export_audio", "File_Export_Dialog"  ],
  [ "File_Menu:Export#export_multiple", "Export_Multiple"  ],
// Don't use the next one, as it is too much detail too soon.
//   [ "File_Menu:_Import#audio", "Importing_Audio"  ],
  ...
  [ "Edit_Menu#copy", "Edit_Menu:_Copy,_Paste_and_Duplicate#copy"  ],
  [ "Edit_Menu#paste", "Edit_Menu:_Copy,_Paste_and_Duplicate#paste"  ],
  [ "Edit_Menu#duplicate", "Edit_Menu:_Copy,_Paste_and_Duplicate#duplicate"  ],
  [ "Edit_Menu:_Labels#edit_labels", "Labels_Editor"   ],
  [ "Edit_Menu:#Metadata", "Metadata"   ],
  [ "Edit_Menu:#Preferences", "Preferences"   ],

  [ "Select_Menu#at_zero_crossings", "Select_Menu:_At_Zero_Crossings"  ],
//  [ "View_Menu:_Track_Size#fit_to_width", "Zooming"  ],
//  [ "View_Menu:_Track_Size#fit_to_height", "Zooming"  ],
  [ "View_Menu#history", "Undo,_Redo_and_History#history"   ],
  [ "View_Menu#karaoke", "Karaoke"  ],
  [ "View_Menu#mixer_board" ,"Mixer_Board"  ],
//  [ "View_Menu:_Toolbars#reset_toolbars", "Toolbars_Overview#arrange"  ],
  [ "View_Menu:_Toolbars#transport_toolbar", "Transport_Toolbar"  ],
  [ "View_Menu:_Toolbars#tools_toolbar", "Tools_Toolbar"  ],
  [ "View_Menu:_Toolbars#recording_meter_toolbar", "Meter_Toolbar#recording"  ],
  [ "View_Menu:_Toolbars#playback_meter_toolbar", "Meter_Toolbar#playback"  ],
  [ "View_Menu:_Toolbars#mixer_toolbar", "Mixer_Toolbar"  ],
  [ "View_Menu:_Toolbars#edit_toolbar", "Edit_Toolbar"  ],
  [ "View_Menu:_Toolbars#transcription_toolbar", "Transcription_Toolbar"  ],
  [ "View_Menu:_Toolbars#scrub_toolbar", "Scrub_Toolbar"  ],
  [ "View_Menu:_Toolbars#device_toolbar", "Device_Toolbar"  ],
  [ "View_Menu:_Toolbars#selection_toolbar", "Selection_Toolbar"  ],
  [ "View_Menu:_Toolbars#spectral_selection_toolbar", "Spectral_Selection_Toolbar"  ],
  [ "Transport_Menu:_Record#timer_record", "Timer_Record"  ],
  [ "Transport_Menu:_Scrubbing#scrub", "Scrubbing_and_Seeking#scrubbing"  ],
  [ "Transport_Menu:_Scrubbing#seek", "Scrubbing_and_Seeking#seeking"  ],
  [ "Transport_Menu:_Scrubbing#scrub_ruler", "Scrubbing_and_Seeking#ruler"  ], // broken anchor link?
//The 4x add tracks are best using the on page info.
//  [ "Tracks_Menu:_Add_New#mono_track",""  ],
  ...
  ["Effect_Menu:_Audacity#amplify", "Amplify"  ],
  ["Effect_Menu:_Audacity#auto_duck", "Auto Duck"  ],
  ["Effect_Menu:_Audacity#bass_and_treble", "Bass and Treble"  ],
  ["Effect_Menu:_Audacity#change_pitch", "Change Pitch"  ],
  ["Effect_Menu:_Audacity#change_speed", "Change Speed"  ],
  ["Effect_Menu:_Audacity#change_tempo", "Change Tempo"  ],
  ["Effect_Menu:_Audacity#classic_filters", "Classic Filters"  ],
  ["Effect_Menu:_Audacity#click_removal", "Click Removal"  ],
  ["Effect_Menu:_Audacity#compressor", "Compressor"  ],
  ["Effect_Menu:_Audacity#distortion", "Distortion"  ],
  ["Effect_Menu:_Audacity#echo", "Echo"  ],
  ["Effect_Menu:_Audacity#equalization", "Equalization"  ],
  ["Effect_Menu:_Audacity#fade_in", "Fades#linearfade"  ],
  ["Effect_Menu:_Audacity#fade_out", "Fades#linearfade"  ],
  ["Effect_Menu:_Audacity#invert", "Invert"  ],
  ["Effect_Menu:_Audacity#noise_reduction", "Noise Reduction"  ],
  ["Effect_Menu:_Audacity#normalize", "Normalize"  ],
  ["Effect_Menu:_Audacity#paulstretch", "Paulstretch"  ],
  ["Effect_Menu:_Audacity#phaser", "Phaser"  ],
  ["Effect_Menu:_Audacity#repair", "Repair"  ],
  ["Effect_Menu:_Audacity#repeat", "Repeat"  ],
  ["Effect_Menu:_Audacity#reverb", "Reverb"  ],
  ["Effect_Menu:_Audacity#reverse", "Reverse"  ],
  ["Effect_Menu:_Audacity#sliding_time_scalepitch_shift", "Sliding Time Scale - Pitch Shift"  ],
  ["Effect_Menu:_Audacity#truncate_silence", "Truncate Silence"  ],
  ["Effect_Menu:_Audacity#wahwah", "Wahwah"  ],
  [ "Effect_Menu:_LADSPA#sc4", "SC4"  ],
  [ "Effect_Menu:_Nyquist#adjustable_fade","Adjustable Fade"  ],
  [ "Effect_Menu:_Nyquist#clip_fix","Clip Fix"   ],
  [ "Effect_Menu:_Nyquist#crossfade_clips","Crossfade Clips"   ],
  [ "Effect_Menu:_Nyquist#crossfade_tracks","Crossfade Tracks"   ],
  [ "Effect_Menu:_Nyquist#delay","Delay"   ],
  [ "Effect_Menu:_Nyquist#high_pass_filter","High Pass Filter"   ],
  [ "Effect_Menu:_Nyquist#limiter","Limiter"   ],
  [ "Effect_Menu:_Nyquist#low_pass_filter","Low Pass Filter"   ],
  [ "Effect_Menu:_Nyquist#notch_filter","Notch Filter"   ],
  [ "Effect_Menu:_Nyquist#nyquist_prompt","Nyquist Prompt"   ],
  [ "Effect_Menu:_Nyquist#spectral_edit_multi_tool","Spectral edit multi tool"   ],
  [ "Effect_Menu:_Nyquist#spectral_edit_parametric_eq","Spectral edit parametric EQ"   ],
  [ "Effect_Menu:_Nyquist#spectral_edit_shelves","Spectral edit shelves"   ],
  [ "Effect_Menu:_Nyquist#studio_fade_out","Fades#studio_fadeout"   ],
  [ "Effect_Menu:_Nyquist#tremolo","Tremolo"   ],
  [ "Effect_Menu:_Nyquist#vocal_reduction_and_isolation","Vocal Reduction and Isolation"   ],
  [ "Effect_Menu:_Nyquist#vocal_remover","Vocal Remover"   ],
  [ "Effect_Menu:_Nyquist#vocoder","Vocoder"   ],
  [ "Analyze_Menu#contrast", "Contrast"   ],
  [ "Analyze_Menu#plot_spectrum","Plot Spectrum"   ],
  [ "Analyze_Menu#find_clipping","Find Clipping"   ],
  [ "Analyze_Menu#beat_finder","Beat Finder"   ],
  [ "Analyze_Menu#regular_interval_labels","Regular Interval Labels"   ],
  [ "Analyze_Menu#sample_data_export","Sample Data Export"   ],
  [ "Analyze_Menu#silence_finder","Silence Finder"   ],
  [ "Analyze_Menu#sound_finder","Sound Finder"   ],
